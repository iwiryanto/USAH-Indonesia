...
key = read_csv(
  "data/OSM-AH-adaptedkey_3.0_20230717.csv") ## Specify filename for OSMtidy-AHgen key

# Read in OSMtidy o-utput RDS file
geoData = readRDS(
  "outputs/Jakarta/Rawa Terate/RawaTerate_7_postProcessing_sf_20240202-151926.RDS") ## Specify filename for OSMtidy output
...
count_AHgen %>% # Specify output object
  saveRDS(filenameTimestamp(
    prefix = "outputs/Jakarta/Rawa Terate/FINAL_count_3.0_RawaTerate_baseline", ## Specify output filepath and filename
...
exportExcel(
  ...
  filenameTimestamp(
    prefix = "outputs/Jakarta/Rawa Terate/FINAL_count_3.0_RawaTerate_baseline", ## Specify filepath and filename
    extension = ".xlsx"))