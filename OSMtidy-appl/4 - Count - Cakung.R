...
geoData = readRDS(
  "outputs/Jakarta/Cakung/Jakarta_Cakung_postProcessing_20240129-153824.RDS") ## Specify filename for OSMtidy output
...
count_AHgen %>% # Specify output object
  saveRDS(filenameTimestamp(
    prefix = "outputs/Jakarta/Cakung/FINAL_count_3.0_Cakung_baseline", ## Specify output filepath and filename
...
exportExcel(
  ...
  filenameTimestamp(
    prefix = "outputs/Jakarta/Cakung/FINAL_count_3.0_Cakung_baseline", ## Specify filepath and filename
    extension = ".xlsx"))