...
outputs_step6 = read_folder(folderName = "./~descCheck/step6-tidied")

# Read in most current OSMAH key
# This is the most current set of desc terms to check against
OSMAHkey = read_csv("OSMAHkey_20210514.csv")
...
outputs_step4 = read_folder(folderName = "./~descCheck/step4-wrangled")
